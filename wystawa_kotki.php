                ...
                <div class="col m-3 w-auto">
                    <div class="card" id="card_'.$kotek['id_kotka'].'" style="width: 18rem; height: 100%;">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-success w-100 shadow-none btn-lajk" id="btn-lajk-'.$kotek['id_kotka'].'"'.($kotek['id_wl'] == $_SESSION['id'] ? ' disabled ' : '').'>'.($kotek['id_wl'] == $_SESSION['id'] ? 'Twój kotek' : 'Supi kotek').'</button>
                        </div>
                    </div>
                </div>';
                }
